...
for city in (cities + cities_all):
	...
	# 	print('Error in accessing mounted data..')
	# 	time.sleep(30)
	# 	print(e.__doc__)
...
app.layout = html.Div(
    ...
    html.Div(id='picked_stats', style={'display': 'none'},
    	children = json.dumps(current_data_cities[cities_all[0]])),
    # dcc.ConfirmDialog(
    #     id='confirm',
