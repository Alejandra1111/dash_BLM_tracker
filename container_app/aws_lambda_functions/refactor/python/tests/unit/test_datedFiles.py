...
class TestDatedDataFilesAndFilters(unittest.TestCase):
    ...
    def test_filename_filter(self):
        filtered_files = [f'tests/unit/fixtures/original/records_2020-08-{d}.json' for d in range(23,26)]
    ...
    def test_filename_filter_with_newer(self):
        filtered_files = [f'tests/unit/fixtures/original/records_2020-08-{d}.json' for d in range(23,29)]
        copy_dateddatafiles = deepcopy(self.dateddatafiles)
