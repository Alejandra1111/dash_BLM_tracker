...
class TestDataLoaderMethods(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        files_original = glob('tests/unit/fixtures/original/*')
        files_wordindex = glob('tests/unit/fixtures/wordindex/*')
        cls.localdata = LocalDataAccess('python/tests/unit/fixtures/original')
        ...
        files_sentiments = glob('tests/unit/fixtures/sentiments/*')
        cls.localdata2 = LocalDataAccess('python/tests/unit/fixtures/sentiments')
