...
def process_new_data():
    ...
    files_original.append_new_filenames(
        alt_filename = f'{data_dest}data_filenames/files_read_BLM_tweet_original_updated.csv')

    files_retweet.append_new_filenames(
        alt_filename = f'{data_dest}data_filenames/files_read_BLM_tweet_retweet_updated.csv')
