    ...
    for file in files:
        ...
        for city in cities:
            if city_type=='city':
                ...
                print(df_file.sample(frac=sample_frac, replace=False).head())
...
if __name__=="__main__":
    ...
    #cities_all = ['all_v1']
    #cities_all = ['all_v2','all_v3','all_v4','all_v5']


    data_path = '/Users/kotaminegishi/big_data_training/python/dash_demo1/'
    #data_path = '/Users/kotaminegishi/big_data_training/python/dash_demo1/new_data/app_data/'
    data_dest = '/Users/kotaminegishi/big_data_training/python/dash_demo1/'

    data_dest_files = data_dest + 'data_cumulative/'


    #list_days = [20, 17, 14, 11, 8, 5, 2]
    #list_days = [20, 17, 17, 14, 11, 8]
    #list_days = [7,1]
    #list_days = [8]
    #list_days = [8, 5, 2]
    #list_days = [29]
    ...
    for d in list_days:
        ...
        base_timestamp = pd.to_datetime(datetime(2020,7, d, 23, 59))
        #base_timestamp = pd.to_datetime(datetime(2020,6, d, 23, 59))
        ...
        #                             data_path, verbose=True, city_type='all', sample_frac=.02)
