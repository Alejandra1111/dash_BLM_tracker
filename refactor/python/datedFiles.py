...
class DatedWordindexFilter:
    ...
    def get_filtered_ids(self, DatedDataFiles, DataLoader=None, DataAccess=None):
        dict_id = {}
        for file in self.files:
            ...
            try:
                ...
                if DataLoader is None or DataAccess is None:
                    raise ValueError('DataLoader or DataAccess is missing.')
